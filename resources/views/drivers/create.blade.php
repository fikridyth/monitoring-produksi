...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Input Driver</h1>
    </div>

    <div class="col-lg-4">
        <form method="post" action="/drivers" class="mb-5">
            @csrf
            <div class="mb-3">
                ...
                <input type="name" class="form-control rounded-top @error('driver') is-invalid @enderror" name="driver"
                    id="driver" placeholder="driver" autofocus value="{{ old('driver') }}">
                @error('driver')
            ...
            <div class="mb-3">
                ...
                <input type="name" class="form-control rounded-top @error('vehicle') is-invalid @enderror" name="vehicle"
                    id="vehicle" placeholder="vehicle" autofocus value="{{ old('vehicle') }}">
                @error('vehicle')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                <label for="inconterm" class="col-form-label">Inconterm:</label>
                <input type="name" class="form-control rounded-top @error('inconterm') is-invalid @enderror"
                    name="inconterm" id="inconterm" placeholder="inconterm" autofocus value="{{ old('inconterm') }}">
                @error('inconterm')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
