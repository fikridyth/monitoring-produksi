...
@section('container')
    ...
    <div class="col-lg-4">
        <form method="post" action="/purchaseorders/{{ $purchaseorder->id }}" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
                <label for="no_sales" class="col-form-label">No Sales:</label>
                <input type="name" class="form-control rounded-top @error('no_sales') is-invalid @enderror" name="no_sales"
                    id="no_sales" placeholder="no_sales" readonly value="{{ old('no_sales', $purchaseorder->no_sales) }}">
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control rounded-top @error('no_po') is-invalid @enderror" name="no_po"
                    id="no_po" placeholder="Input No PO" autofocus value="{{ old('no_po', $purchaseorder->no_po) }}">
                @error('no_po')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control rounded-top @error('no_pr') is-invalid @enderror" name="no_pr"
                    id="no_pr" placeholder="Input No PR" value="{{ old('no_pr', $purchaseorder->no_pr) }}">
                @error('no_pr')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('no_item') is-invalid @enderror" name="no_item"
                    id="no_item" placeholder="Input No Item" value="{{ old('no_item', $purchaseorder->no_item) }}">
                @error('no_item')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="supplier" name="supplier_id">
                    @foreach ($suppliers as $supplier)
                        @if (old('supplier_id', $purchaseorder->supplier_id) == $supplier->id)
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control rounded-top @error('date') is-invalid @enderror" name="date"
                    id="date" value="{{ old('date', $purchaseorder->date) }}">
                @error('date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="desc">
                    <option value="{{ old('desc', $purchaseorder->desc) }}" selected>
                        {{ old('desc', $purchaseorder->desc) }}</option>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('panjang') is-invalid @enderror" name="panjang"
                    id="panjang" placeholder="panjang" value="{{ old('panjang', $purchaseorder->panjang) }}">
                @error('panjang')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('lebar') is-invalid @enderror" name="lebar"
                    id="lebar" placeholder="lebar" value="{{ old('lebar', $purchaseorder->lebar) }}">
                @error('lebar')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('lebar_paper') is-invalid @enderror"
                    name="lebar_paper" id="lebar_paper" placeholder="lebar_paper"
                    value="{{ old('lebar_paper', $purchaseorder->lebar_paper) }}">
                @error('lebar_paper')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('out_paper') is-invalid @enderror"
                    name="out_paper" id="out_paper" placeholder="out_paper"
                    value="{{ old('out_paper', $purchaseorder->out_paper) }}">
                @error('out_paper')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control rounded-top @error('score') is-invalid @enderror" name="score"
                    id="score" placeholder="score" value="{{ old('score', $purchaseorder->score) }}">
                @error('score')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control rounded-top @error('substance') is-invalid @enderror"
                    name="substance" id="substance" placeholder="substance"
                    value="{{ old('substance', $purchaseorder->substance) }}">
                @error('substance')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="flute">
                    <option value="{{ old('flute', $purchaseorder->flute) }}" selected>
                        {{ old('flute', $purchaseorder->flute) }}</option>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('index') is-invalid @enderror" name="index"
                    id="index" placeholder="index" value="{{ old('index', $purchaseorder->index) }}">
                @error('index')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('disc') is-invalid @enderror" name="disc"
                    id="disc" placeholder="disc" value="{{ old('disc', $purchaseorder->disc) }}">
                @error('disc')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('qty') is-invalid @enderror" name="qty"
                    id="qty" placeholder="qty" value="{{ old('qty', $purchaseorder->qty) }}">
                @error('qty')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control rounded-top @error('date_delivery') is-invalid @enderror"
                    name="date_delivery" id="date_delivery"
                    value="{{ old('date_delivery', $purchaseorder->date_delivery) }}">
                @error('date_delivery')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control rounded-top @error('price') is-invalid @enderror" name="price"
                    id="price" placeholder="price" value="{{ old('price', $purchaseorder->price) }}">
                @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
