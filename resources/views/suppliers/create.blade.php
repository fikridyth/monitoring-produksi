...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Input New Supplier</h1>
    </div>

    <div class="col-lg-4">
        <form method="post" action="/suppliers" class="mb-5">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="name" class="form-control rounded-top @error('alamat2') is-invalid @enderror" name="alamat2"
                    id="alamat2" placeholder="Input Kota" value="{{ old('alamat2') }}">
                @error('alamat2')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="name" class="form-control rounded-top @error('cp_person') is-invalid @enderror"
                    name="cp_person" id="cp_person" placeholder="Input Nama Kontak" value="{{ old('cp_person') }}">
                @error('cp_person')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="name" class="form-control rounded-top @error('cp_telp') is-invalid @enderror" name="cp_telp"
                    id="cp_telp" placeholder="Input Nomor Kontak" value="{{ old('cp_telp') }}">
                @error('cp_telp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
