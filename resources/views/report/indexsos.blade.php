...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Laporan Sales Order</h1>
    </div>

    <div class="table-responsive">
        <div class="card-header">
            <h3>Pilih Tanggal Data Sales Order</h3>
        </div>
        <div class="card-body">
            ...
            <div class="input-group mb-3">
                <a href=""
                    onclick="this.href='/reportsos/'+document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
